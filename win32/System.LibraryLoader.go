...
type ENUMRESLANGPROCA func(hModule HINSTANCE, lpType PSTR, lpName PSTR, wLanguage uint16, lParam uintptr) BOOL

type ENUMRESLANGPROCW func(hModule HINSTANCE, lpType PWSTR, lpName PWSTR, wLanguage uint16, lParam uintptr) BOOL

type ENUMRESNAMEPROCA func(hModule HINSTANCE, lpType PSTR, lpName PSTR, lParam uintptr) BOOL

type ENUMRESNAMEPROCW func(hModule HINSTANCE, lpType PWSTR, lpName PWSTR, lParam uintptr) BOOL

type ENUMRESTYPEPROCA func(hModule HINSTANCE, lpType PSTR, lParam uintptr) BOOL

type ENUMRESTYPEPROCW func(hModule HINSTANCE, lpType PWSTR, lParam uintptr) BOOL

type PGET_MODULE_HANDLE_EXA func(dwFlags uint32, lpModuleName PSTR, phModule *HINSTANCE) BOOL

type PGET_MODULE_HANDLE_EXW func(dwFlags uint32, lpModuleName PWSTR, phModule *HINSTANCE) BOOL
...
func FreeLibraryAndExitThread(hLibModule HINSTANCE, dwExitCode uint32) {
	...
	_, _,  _ = syscall.SyscallN(addr, hLibModule, uintptr(dwExitCode))
}
...
func GetModuleFileNameA(hModule HINSTANCE, lpFilename *uint8, nSize uint32) (uint32, WIN32_ERROR) {
...
func GetModuleFileNameW(hModule HINSTANCE, lpFilename *uint16, nSize uint32) (uint32, WIN32_ERROR) {
...
func GetModuleHandleA(lpModuleName PSTR) (HINSTANCE, WIN32_ERROR) {
	...
	return HINSTANCE(ret), WIN32_ERROR(err)
}
...
func GetProcAddress(hModule HINSTANCE, lpProcName PSTR) (uintptr, WIN32_ERROR) {
...
func EnumResourceLanguagesExA(hModule HINSTANCE, lpType PSTR, lpName PSTR, lpEnumFunc uintptr, lParam uintptr, dwFlags uint32, LangId uint16) (BOOL, WIN32_ERROR) {
	addr := lazyAddr(&pEnumResourceLanguagesExA, libKernel32, "EnumResourceLanguagesExA")
	ret, _,  err := syscall.SyscallN(addr, hModule, uintptr(unsafe.Pointer(lpType)), uintptr(unsafe.Pointer(lpName)), uintptr(lpEnumFunc), uintptr(lParam), uintptr(dwFlags), uintptr(LangId))
	return BOOL(ret), WIN32_ERROR(err)
}

var EnumResourceLanguagesEx = EnumResourceLanguagesExW
func EnumResourceLanguagesExW(hModule HINSTANCE, lpType PWSTR, lpName PWSTR, lpEnumFunc uintptr, lParam uintptr, dwFlags uint32, LangId uint16) (BOOL, WIN32_ERROR) {
	addr := lazyAddr(&pEnumResourceLanguagesExW, libKernel32, "EnumResourceLanguagesExW")
	ret, _,  err := syscall.SyscallN(addr, hModule, uintptr(unsafe.Pointer(lpType)), uintptr(unsafe.Pointer(lpName)), uintptr(lpEnumFunc), uintptr(lParam), uintptr(dwFlags), uintptr(LangId))
	return BOOL(ret), WIN32_ERROR(err)
}

func EnumResourceNamesExA(hModule HINSTANCE, lpType PSTR, lpEnumFunc uintptr, lParam uintptr, dwFlags uint32, LangId uint16) (BOOL, WIN32_ERROR) {
	addr := lazyAddr(&pEnumResourceNamesExA, libKernel32, "EnumResourceNamesExA")
	ret, _,  err := syscall.SyscallN(addr, hModule, uintptr(unsafe.Pointer(lpType)), uintptr(lpEnumFunc), uintptr(lParam), uintptr(dwFlags), uintptr(LangId))
	return BOOL(ret), WIN32_ERROR(err)
}

var EnumResourceNamesEx = EnumResourceNamesExW
func EnumResourceNamesExW(hModule HINSTANCE, lpType PWSTR, lpEnumFunc uintptr, lParam uintptr, dwFlags uint32, LangId uint16) (BOOL, WIN32_ERROR) {
	addr := lazyAddr(&pEnumResourceNamesExW, libKernel32, "EnumResourceNamesExW")
	ret, _,  err := syscall.SyscallN(addr, hModule, uintptr(unsafe.Pointer(lpType)), uintptr(lpEnumFunc), uintptr(lParam), uintptr(dwFlags), uintptr(LangId))
	return BOOL(ret), WIN32_ERROR(err)
}

func EnumResourceTypesExA(hModule HINSTANCE, lpEnumFunc uintptr, lParam uintptr, dwFlags uint32, LangId uint16) (BOOL, WIN32_ERROR) {
	addr := lazyAddr(&pEnumResourceTypesExA, libKernel32, "EnumResourceTypesExA")
	ret, _,  err := syscall.SyscallN(addr, hModule, uintptr(lpEnumFunc), uintptr(lParam), uintptr(dwFlags), uintptr(LangId))
	return BOOL(ret), WIN32_ERROR(err)
}

var EnumResourceTypesEx = EnumResourceTypesExW
func EnumResourceTypesExW(hModule HINSTANCE, lpEnumFunc uintptr, lParam uintptr, dwFlags uint32, LangId uint16) (BOOL, WIN32_ERROR) {
...
func EnumResourceNamesW(hModule HINSTANCE, lpType PWSTR, lpEnumFunc uintptr, lParam uintptr) BOOL {
	addr := lazyAddr(&pEnumResourceNamesW, libKernel32, "EnumResourceNamesW")
	ret, _,  _ := syscall.SyscallN(addr, hModule, uintptr(unsafe.Pointer(lpType)), uintptr(lpEnumFunc), uintptr(lParam))
	return BOOL(ret)
}

func EnumResourceNamesA(hModule HINSTANCE, lpType PSTR, lpEnumFunc uintptr, lParam uintptr) (BOOL, WIN32_ERROR) {
	addr := lazyAddr(&pEnumResourceNamesA, libKernel32, "EnumResourceNamesA")
	ret, _,  err := syscall.SyscallN(addr, hModule, uintptr(unsafe.Pointer(lpType)), uintptr(lpEnumFunc), uintptr(lParam))
	return BOOL(ret), WIN32_ERROR(err)
}
...
func FindResourceA(hModule HINSTANCE, lpName PSTR, lpType PSTR) (HRSRC, WIN32_ERROR) {
	...
	return HRSRC(ret), WIN32_ERROR(err)
}
...
func EnumResourceTypesA(hModule HINSTANCE, lpEnumFunc uintptr, lParam uintptr) (BOOL, WIN32_ERROR) {
	addr := lazyAddr(&pEnumResourceTypesA, libKernel32, "EnumResourceTypesA")
	ret, _,  err := syscall.SyscallN(addr, hModule, uintptr(lpEnumFunc), uintptr(lParam))
	return BOOL(ret), WIN32_ERROR(err)
}

var EnumResourceTypes = EnumResourceTypesW
func EnumResourceTypesW(hModule HINSTANCE, lpEnumFunc uintptr, lParam uintptr) (BOOL, WIN32_ERROR) {
	addr := lazyAddr(&pEnumResourceTypesW, libKernel32, "EnumResourceTypesW")
	ret, _,  err := syscall.SyscallN(addr, hModule, uintptr(lpEnumFunc), uintptr(lParam))
	return BOOL(ret), WIN32_ERROR(err)
}

func EnumResourceLanguagesA(hModule HINSTANCE, lpType PSTR, lpName PSTR, lpEnumFunc uintptr, lParam uintptr) (BOOL, WIN32_ERROR) {
	addr := lazyAddr(&pEnumResourceLanguagesA, libKernel32, "EnumResourceLanguagesA")
	ret, _,  err := syscall.SyscallN(addr, hModule, uintptr(unsafe.Pointer(lpType)), uintptr(unsafe.Pointer(lpName)), uintptr(lpEnumFunc), uintptr(lParam))
	return BOOL(ret), WIN32_ERROR(err)
}

var EnumResourceLanguages = EnumResourceLanguagesW
func EnumResourceLanguagesW(hModule HINSTANCE, lpType PWSTR, lpName PWSTR, lpEnumFunc uintptr, lParam uintptr) (BOOL, WIN32_ERROR) {
...
func GetDllDirectoryA(nBufferLength uint32, lpBuffer *uint8) (uint32, WIN32_ERROR) {
...
func GetDllDirectoryW(nBufferLength uint32, lpBuffer *uint16) (uint32, WIN32_ERROR) {
