...
// enum READ_EVENT_LOG_READ_FLAGS
...
type EVT_VARIANT_Anonymous_ struct {
	Data [1]uint64
}

func (this *EVT_VARIANT_Anonymous_) BooleanVal() *BOOL{
	return (*BOOL)(unsafe.Pointer(this))
}

func (this *EVT_VARIANT_Anonymous_) BooleanValVal() BOOL{
	return *(*BOOL)(unsafe.Pointer(this))
}

func (this *EVT_VARIANT_Anonymous_) SByteVal() *int8{
	return (*int8)(unsafe.Pointer(this))
}

func (this *EVT_VARIANT_Anonymous_) SByteValVal() int8{
	return *(*int8)(unsafe.Pointer(this))
}

func (this *EVT_VARIANT_Anonymous_) Int16Val() *int16{
	return (*int16)(unsafe.Pointer(this))
}

func (this *EVT_VARIANT_Anonymous_) Int16ValVal() int16{
	return *(*int16)(unsafe.Pointer(this))
}

func (this *EVT_VARIANT_Anonymous_) Int32Val() *int32{
	return (*int32)(unsafe.Pointer(this))
}

func (this *EVT_VARIANT_Anonymous_) Int32ValVal() int32{
	return *(*int32)(unsafe.Pointer(this))
}

func (this *EVT_VARIANT_Anonymous_) Int64Val() *int64{
	return (*int64)(unsafe.Pointer(this))
}

func (this *EVT_VARIANT_Anonymous_) Int64ValVal() int64{
	return *(*int64)(unsafe.Pointer(this))
}

func (this *EVT_VARIANT_Anonymous_) ByteVal() *uint8{
	return (*uint8)(unsafe.Pointer(this))
}

func (this *EVT_VARIANT_Anonymous_) ByteValVal() uint8{
	return *(*uint8)(unsafe.Pointer(this))
}

func (this *EVT_VARIANT_Anonymous_) UInt16Val() *uint16{
	return (*uint16)(unsafe.Pointer(this))
}

func (this *EVT_VARIANT_Anonymous_) UInt16ValVal() uint16{
	return *(*uint16)(unsafe.Pointer(this))
}

func (this *EVT_VARIANT_Anonymous_) UInt32Val() *uint32{
	return (*uint32)(unsafe.Pointer(this))
}

func (this *EVT_VARIANT_Anonymous_) UInt32ValVal() uint32{
	return *(*uint32)(unsafe.Pointer(this))
}

func (this *EVT_VARIANT_Anonymous_) UInt64Val() *uint64{
	return (*uint64)(unsafe.Pointer(this))
}

func (this *EVT_VARIANT_Anonymous_) UInt64ValVal() uint64{
	return *(*uint64)(unsafe.Pointer(this))
}

func (this *EVT_VARIANT_Anonymous_) SingleVal() *float32{
	return (*float32)(unsafe.Pointer(this))
}

func (this *EVT_VARIANT_Anonymous_) SingleValVal() float32{
	return *(*float32)(unsafe.Pointer(this))
}

func (this *EVT_VARIANT_Anonymous_) DoubleVal() *float64{
	return (*float64)(unsafe.Pointer(this))
}

func (this *EVT_VARIANT_Anonymous_) DoubleValVal() float64{
	return *(*float64)(unsafe.Pointer(this))
}

func (this *EVT_VARIANT_Anonymous_) FileTimeVal() *uint64{
	return (*uint64)(unsafe.Pointer(this))
}

func (this *EVT_VARIANT_Anonymous_) FileTimeValVal() uint64{
	return *(*uint64)(unsafe.Pointer(this))
}

func (this *EVT_VARIANT_Anonymous_) SysTimeVal() **SYSTEMTIME{
	return (**SYSTEMTIME)(unsafe.Pointer(this))
}

func (this *EVT_VARIANT_Anonymous_) SysTimeValVal() *SYSTEMTIME{
	return *(**SYSTEMTIME)(unsafe.Pointer(this))
}

func (this *EVT_VARIANT_Anonymous_) GuidVal() **syscall.GUID{
	return (**syscall.GUID)(unsafe.Pointer(this))
}

func (this *EVT_VARIANT_Anonymous_) GuidValVal() *syscall.GUID{
	return *(**syscall.GUID)(unsafe.Pointer(this))
}

func (this *EVT_VARIANT_Anonymous_) StringVal() *PWSTR{
	return (*PWSTR)(unsafe.Pointer(this))
}

func (this *EVT_VARIANT_Anonymous_) StringValVal() PWSTR{
	return *(*PWSTR)(unsafe.Pointer(this))
}

func (this *EVT_VARIANT_Anonymous_) AnsiStringVal() *PSTR{
	return (*PSTR)(unsafe.Pointer(this))
}

func (this *EVT_VARIANT_Anonymous_) AnsiStringValVal() PSTR{
	return *(*PSTR)(unsafe.Pointer(this))
}

func (this *EVT_VARIANT_Anonymous_) BinaryVal() **uint8{
	return (**uint8)(unsafe.Pointer(this))
}

func (this *EVT_VARIANT_Anonymous_) BinaryValVal() *uint8{
	return *(**uint8)(unsafe.Pointer(this))
}

func (this *EVT_VARIANT_Anonymous_) SidVal() *PSID{
	return (*PSID)(unsafe.Pointer(this))
}

func (this *EVT_VARIANT_Anonymous_) SidValVal() PSID{
	return *(*PSID)(unsafe.Pointer(this))
}

func (this *EVT_VARIANT_Anonymous_) SizeTVal() *uintptr{
	return (*uintptr)(unsafe.Pointer(this))
}

func (this *EVT_VARIANT_Anonymous_) SizeTValVal() uintptr{
	return *(*uintptr)(unsafe.Pointer(this))
}

func (this *EVT_VARIANT_Anonymous_) BooleanArr() **BOOL{
	return (**BOOL)(unsafe.Pointer(this))
}

func (this *EVT_VARIANT_Anonymous_) BooleanArrVal() *BOOL{
	return *(**BOOL)(unsafe.Pointer(this))
}

func (this *EVT_VARIANT_Anonymous_) SByteArr() **int8{
	return (**int8)(unsafe.Pointer(this))
}

func (this *EVT_VARIANT_Anonymous_) SByteArrVal() *int8{
	return *(**int8)(unsafe.Pointer(this))
}

func (this *EVT_VARIANT_Anonymous_) Int16Arr() **int16{
	return (**int16)(unsafe.Pointer(this))
}

func (this *EVT_VARIANT_Anonymous_) Int16ArrVal() *int16{
	return *(**int16)(unsafe.Pointer(this))
}

func (this *EVT_VARIANT_Anonymous_) Int32Arr() **int32{
	return (**int32)(unsafe.Pointer(this))
}

func (this *EVT_VARIANT_Anonymous_) Int32ArrVal() *int32{
	return *(**int32)(unsafe.Pointer(this))
}

func (this *EVT_VARIANT_Anonymous_) Int64Arr() **int64{
	return (**int64)(unsafe.Pointer(this))
}

func (this *EVT_VARIANT_Anonymous_) Int64ArrVal() *int64{
	return *(**int64)(unsafe.Pointer(this))
}

func (this *EVT_VARIANT_Anonymous_) ByteArr() **uint8{
	return (**uint8)(unsafe.Pointer(this))
}

func (this *EVT_VARIANT_Anonymous_) ByteArrVal() *uint8{
	return *(**uint8)(unsafe.Pointer(this))
}

func (this *EVT_VARIANT_Anonymous_) UInt16Arr() **uint16{
	return (**uint16)(unsafe.Pointer(this))
}

func (this *EVT_VARIANT_Anonymous_) UInt16ArrVal() *uint16{
	return *(**uint16)(unsafe.Pointer(this))
}

func (this *EVT_VARIANT_Anonymous_) UInt32Arr() **uint32{
	return (**uint32)(unsafe.Pointer(this))
}

func (this *EVT_VARIANT_Anonymous_) UInt32ArrVal() *uint32{
	return *(**uint32)(unsafe.Pointer(this))
}

func (this *EVT_VARIANT_Anonymous_) UInt64Arr() **uint64{
	return (**uint64)(unsafe.Pointer(this))
}

func (this *EVT_VARIANT_Anonymous_) UInt64ArrVal() *uint64{
	return *(**uint64)(unsafe.Pointer(this))
}

func (this *EVT_VARIANT_Anonymous_) SingleArr() **float32{
	return (**float32)(unsafe.Pointer(this))
}

func (this *EVT_VARIANT_Anonymous_) SingleArrVal() *float32{
	return *(**float32)(unsafe.Pointer(this))
}

func (this *EVT_VARIANT_Anonymous_) DoubleArr() **float64{
	return (**float64)(unsafe.Pointer(this))
}

func (this *EVT_VARIANT_Anonymous_) DoubleArrVal() *float64{
	return *(**float64)(unsafe.Pointer(this))
}

func (this *EVT_VARIANT_Anonymous_) FileTimeArr() **FILETIME{
	return (**FILETIME)(unsafe.Pointer(this))
}

func (this *EVT_VARIANT_Anonymous_) FileTimeArrVal() *FILETIME{
	return *(**FILETIME)(unsafe.Pointer(this))
}

func (this *EVT_VARIANT_Anonymous_) SysTimeArr() **SYSTEMTIME{
	return (**SYSTEMTIME)(unsafe.Pointer(this))
}

func (this *EVT_VARIANT_Anonymous_) SysTimeArrVal() *SYSTEMTIME{
	return *(**SYSTEMTIME)(unsafe.Pointer(this))
}

func (this *EVT_VARIANT_Anonymous_) GuidArr() **syscall.GUID{
	return (**syscall.GUID)(unsafe.Pointer(this))
}

func (this *EVT_VARIANT_Anonymous_) GuidArrVal() *syscall.GUID{
	return *(**syscall.GUID)(unsafe.Pointer(this))
}

func (this *EVT_VARIANT_Anonymous_) StringArr() **PWSTR{
	return (**PWSTR)(unsafe.Pointer(this))
}

func (this *EVT_VARIANT_Anonymous_) StringArrVal() *PWSTR{
	return *(**PWSTR)(unsafe.Pointer(this))
}

func (this *EVT_VARIANT_Anonymous_) AnsiStringArr() **PSTR{
	return (**PSTR)(unsafe.Pointer(this))
}

func (this *EVT_VARIANT_Anonymous_) AnsiStringArrVal() *PSTR{
	return *(**PSTR)(unsafe.Pointer(this))
}

func (this *EVT_VARIANT_Anonymous_) SidArr() **PSID{
	return (**PSID)(unsafe.Pointer(this))
}

func (this *EVT_VARIANT_Anonymous_) SidArrVal() *PSID{
	return *(**PSID)(unsafe.Pointer(this))
}

func (this *EVT_VARIANT_Anonymous_) SizeTArr() **uintptr{
	return (**uintptr)(unsafe.Pointer(this))
}

func (this *EVT_VARIANT_Anonymous_) SizeTArrVal() *uintptr{
	return *(**uintptr)(unsafe.Pointer(this))
}

func (this *EVT_VARIANT_Anonymous_) EvtHandleVal() *uintptr{
	return (*uintptr)(unsafe.Pointer(this))
}

func (this *EVT_VARIANT_Anonymous_) EvtHandleValVal() uintptr{
	return *(*uintptr)(unsafe.Pointer(this))
}

func (this *EVT_VARIANT_Anonymous_) XmlVal() *PWSTR{
	return (*PWSTR)(unsafe.Pointer(this))
}

func (this *EVT_VARIANT_Anonymous_) XmlValVal() PWSTR{
	return *(*PWSTR)(unsafe.Pointer(this))
}

func (this *EVT_VARIANT_Anonymous_) XmlValArr() **PWSTR{
	return (**PWSTR)(unsafe.Pointer(this))
}

func (this *EVT_VARIANT_Anonymous_) XmlValArrVal() *PWSTR{
	return *(**PWSTR)(unsafe.Pointer(this))
}

type EVT_VARIANT struct {
	EVT_VARIANT_Anonymous_
	Count uint32
	Type uint32
}
...
type EVT_SUBSCRIBE_CALLBACK func(Action EVT_SUBSCRIBE_NOTIFY_ACTION, UserContext unsafe.Pointer, Event uintptr) uint32
...
func OpenEventLogA(lpUNCServerName PSTR, lpSourceName PSTR) (EventLogHandle, WIN32_ERROR) {
	...
	return EventLogHandle(ret), WIN32_ERROR(err)
}
...
func RegisterEventSourceA(lpUNCServerName PSTR, lpSourceName PSTR) (EventSourceHandle, WIN32_ERROR) {
	...
	ret, _,  err := syscall.SyscallN(addr, uintptr(unsafe.Pointer(lpUNCServerName)), uintptr(unsafe.Pointer(lpSourceName)))
	return EventSourceHandle(ret), WIN32_ERROR(err)
}
...
func ReportEventA(hEventLog HANDLE, wType REPORT_EVENT_TYPE, wCategory uint16, dwEventID uint32, lpUserSid PSID, wNumStrings uint16, dwDataSize uint32, lpStrings *PSTR, lpRawData unsafe.Pointer) (BOOL, WIN32_ERROR) {
	...
	ret, _,  err := syscall.SyscallN(addr, hEventLog, uintptr(wType), uintptr(wCategory), uintptr(dwEventID), lpUserSid, uintptr(wNumStrings), uintptr(dwDataSize), uintptr(unsafe.Pointer(lpStrings)), uintptr(lpRawData))
	return BOOL(ret), WIN32_ERROR(err)
}
