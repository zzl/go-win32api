...
func RegEnumKeyA(hKey HKEY, dwIndex uint32, lpName *uint8, cchName uint32) WIN32_ERROR {
...
func RegEnumKeyW(hKey HKEY, dwIndex uint32, lpName *uint16, cchName uint32) WIN32_ERROR {
	addr := lazyAddr(&pRegEnumKeyW, libAdvapi32, "RegEnumKeyW")
	ret, _,  _ := syscall.SyscallN(addr, hKey, uintptr(dwIndex), uintptr(unsafe.Pointer(lpName)), uintptr(cchName))
	return WIN32_ERROR(ret)
}

func RegEnumKeyExA(hKey HKEY, dwIndex uint32, lpName *uint8, lpcchName *uint32, lpReserved *uint32, lpClass *uint8, lpcchClass *uint32, lpftLastWriteTime *FILETIME) WIN32_ERROR {
...
func RegEnumKeyExW(hKey HKEY, dwIndex uint32, lpName *uint16, lpcchName *uint32, lpReserved *uint32, lpClass *uint16, lpcchClass *uint32, lpftLastWriteTime *FILETIME) WIN32_ERROR {
	addr := lazyAddr(&pRegEnumKeyExW, libAdvapi32, "RegEnumKeyExW")
	ret, _,  _ := syscall.SyscallN(addr, hKey, uintptr(dwIndex), uintptr(unsafe.Pointer(lpName)), uintptr(unsafe.Pointer(lpcchName)), uintptr(unsafe.Pointer(lpReserved)), uintptr(unsafe.Pointer(lpClass)), uintptr(unsafe.Pointer(lpcchClass)), uintptr(unsafe.Pointer(lpftLastWriteTime)))
	return WIN32_ERROR(ret)
}

func RegEnumValueA(hKey HKEY, dwIndex uint32, lpValueName *uint8, lpcchValueName *uint32, lpReserved *uint32, lpType *uint32, lpData *uint8, lpcbData *uint32) WIN32_ERROR {
...
func RegEnumValueW(hKey HKEY, dwIndex uint32, lpValueName *uint16, lpcchValueName *uint32, lpReserved *uint32, lpType *uint32, lpData *uint8, lpcbData *uint32) WIN32_ERROR {
...
func RegQueryInfoKeyA(hKey HKEY, lpClass *uint8, lpcchClass *uint32, lpReserved *uint32, lpcSubKeys *uint32, lpcbMaxSubKeyLen *uint32, lpcbMaxClassLen *uint32, lpcValues *uint32, lpcbMaxValueNameLen *uint32, lpcbMaxValueLen *uint32, lpcbSecurityDescriptor *uint32, lpftLastWriteTime *FILETIME) WIN32_ERROR {
...
func RegQueryInfoKeyW(hKey HKEY, lpClass *uint16, lpcchClass *uint32, lpReserved *uint32, lpcSubKeys *uint32, lpcbMaxSubKeyLen *uint32, lpcbMaxClassLen *uint32, lpcValues *uint32, lpcbMaxValueNameLen *uint32, lpcbMaxValueLen *uint32, lpcbSecurityDescriptor *uint32, lpftLastWriteTime *FILETIME) WIN32_ERROR {
...
func RegQueryValueExA(hKey HKEY, lpValueName PSTR, lpReserved *uint32, lpType *REG_VALUE_TYPE, lpData *uint8, lpcbData *uint32) WIN32_ERROR {
...
func RegQueryValueExW(hKey HKEY, lpValueName PWSTR, lpReserved *uint32, lpType *REG_VALUE_TYPE, lpData *uint8, lpcbData *uint32) WIN32_ERROR {
...
func RegSetValueExA(hKey HKEY, lpValueName PSTR, Reserved uint32, dwType REG_VALUE_TYPE, lpData *uint8, cbData uint32) WIN32_ERROR {
...
func RegSetValueExW(hKey HKEY, lpValueName PWSTR, Reserved uint32, dwType REG_VALUE_TYPE, lpData *uint8, cbData uint32) WIN32_ERROR {
