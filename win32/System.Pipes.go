...
func GetNamedPipeHandleStateW(hNamedPipe HANDLE, lpState *NAMED_PIPE_MODE, lpCurInstances *uint32, lpMaxCollectionCount *uint32, lpCollectDataTimeout *uint32, lpUserName *uint16, nMaxUserNameSize uint32) BOOL {
...
func GetNamedPipeHandleStateA(hNamedPipe HANDLE, lpState *NAMED_PIPE_MODE, lpCurInstances *uint32, lpMaxCollectionCount *uint32, lpCollectDataTimeout *uint32, lpUserName *uint8, nMaxUserNameSize uint32) (BOOL, WIN32_ERROR) {
