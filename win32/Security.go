...
// enum TOKEN_PRIVILEGES_ATTRIBUTES
// flags
...
// enum CREATE_RESTRICTED_TOKEN_FLAGS
// flags
...
// enum SECURITY_AUTO_INHERIT_FLAGS
// flags
...
// enum TOKEN_MANDATORY_POLICY_ID
...
// enum SYSTEM_AUDIT_OBJECT_ACE_FLAGS
// flags
...
// enum CLAIM_SECURITY_ATTRIBUTE_FLAGS
// flags
...
// enum CLAIM_SECURITY_ATTRIBUTE_VALUE_TYPE
...
type LLFILETIME_Anonymous_ struct {
	Data [1]uint64
}

func (this *LLFILETIME_Anonymous_) Ll() *int64{
	return (*int64)(unsafe.Pointer(this))
}

func (this *LLFILETIME_Anonymous_) LlVal() int64{
	return *(*int64)(unsafe.Pointer(this))
}

func (this *LLFILETIME_Anonymous_) Ft() *FILETIME{
	return (*FILETIME)(unsafe.Pointer(this))
}

func (this *LLFILETIME_Anonymous_) FtVal() FILETIME{
	return *(*FILETIME)(unsafe.Pointer(this))
}

type LLFILETIME struct {
	LLFILETIME_Anonymous_
}
...
func (this *SE_SID) Buffer() *[68]uint8{
	return (*[68]uint8)(unsafe.Pointer(this))
}

func (this *SE_SID) BufferVal() [68]uint8{
	return *(*[68]uint8)(unsafe.Pointer(this))
}
...
type CLAIM_SECURITY_ATTRIBUTE_V1_Values_ struct {
	Data [1]uint64
}

func (this *CLAIM_SECURITY_ATTRIBUTE_V1_Values_) PInt64() **int64{
	return (**int64)(unsafe.Pointer(this))
}

func (this *CLAIM_SECURITY_ATTRIBUTE_V1_Values_) PInt64Val() *int64{
	return *(**int64)(unsafe.Pointer(this))
}

func (this *CLAIM_SECURITY_ATTRIBUTE_V1_Values_) PUint64() **uint64{
	return (**uint64)(unsafe.Pointer(this))
}

func (this *CLAIM_SECURITY_ATTRIBUTE_V1_Values_) PUint64Val() *uint64{
	return *(**uint64)(unsafe.Pointer(this))
}

func (this *CLAIM_SECURITY_ATTRIBUTE_V1_Values_) PpString() **PWSTR{
	return (**PWSTR)(unsafe.Pointer(this))
}

func (this *CLAIM_SECURITY_ATTRIBUTE_V1_Values_) PpStringVal() *PWSTR{
	return *(**PWSTR)(unsafe.Pointer(this))
}

func (this *CLAIM_SECURITY_ATTRIBUTE_V1_Values_) PFqbn() **CLAIM_SECURITY_ATTRIBUTE_FQBN_VALUE{
	return (**CLAIM_SECURITY_ATTRIBUTE_FQBN_VALUE)(unsafe.Pointer(this))
}

func (this *CLAIM_SECURITY_ATTRIBUTE_V1_Values_) PFqbnVal() *CLAIM_SECURITY_ATTRIBUTE_FQBN_VALUE{
	return *(**CLAIM_SECURITY_ATTRIBUTE_FQBN_VALUE)(unsafe.Pointer(this))
}

func (this *CLAIM_SECURITY_ATTRIBUTE_V1_Values_) POctetString() **CLAIM_SECURITY_ATTRIBUTE_OCTET_STRING_VALUE{
	return (**CLAIM_SECURITY_ATTRIBUTE_OCTET_STRING_VALUE)(unsafe.Pointer(this))
}

func (this *CLAIM_SECURITY_ATTRIBUTE_V1_Values_) POctetStringVal() *CLAIM_SECURITY_ATTRIBUTE_OCTET_STRING_VALUE{
	return *(**CLAIM_SECURITY_ATTRIBUTE_OCTET_STRING_VALUE)(unsafe.Pointer(this))
}
...
type CLAIM_SECURITY_ATTRIBUTE_V1 struct {
	...
	Flags uint32
	ValueCount uint32
	Values CLAIM_SECURITY_ATTRIBUTE_V1_Values_
}

type CLAIM_SECURITY_ATTRIBUTE_RELATIVE_V1_Values_ struct {
	Data [1]uint32
}

func (this *CLAIM_SECURITY_ATTRIBUTE_RELATIVE_V1_Values_) PInt64() *[1]uint32{
	return (*[1]uint32)(unsafe.Pointer(this))
}

func (this *CLAIM_SECURITY_ATTRIBUTE_RELATIVE_V1_Values_) PInt64Val() [1]uint32{
	return *(*[1]uint32)(unsafe.Pointer(this))
}

func (this *CLAIM_SECURITY_ATTRIBUTE_RELATIVE_V1_Values_) PUint64() *[1]uint32{
	return (*[1]uint32)(unsafe.Pointer(this))
}

func (this *CLAIM_SECURITY_ATTRIBUTE_RELATIVE_V1_Values_) PUint64Val() [1]uint32{
	return *(*[1]uint32)(unsafe.Pointer(this))
}

func (this *CLAIM_SECURITY_ATTRIBUTE_RELATIVE_V1_Values_) PpString() *[1]uint32{
	return (*[1]uint32)(unsafe.Pointer(this))
}

func (this *CLAIM_SECURITY_ATTRIBUTE_RELATIVE_V1_Values_) PpStringVal() [1]uint32{
	return *(*[1]uint32)(unsafe.Pointer(this))
}

func (this *CLAIM_SECURITY_ATTRIBUTE_RELATIVE_V1_Values_) PFqbn() *[1]uint32{
	return (*[1]uint32)(unsafe.Pointer(this))
}

func (this *CLAIM_SECURITY_ATTRIBUTE_RELATIVE_V1_Values_) PFqbnVal() [1]uint32{
	return *(*[1]uint32)(unsafe.Pointer(this))
}

func (this *CLAIM_SECURITY_ATTRIBUTE_RELATIVE_V1_Values_) POctetString() *[1]uint32{
	return (*[1]uint32)(unsafe.Pointer(this))
}

func (this *CLAIM_SECURITY_ATTRIBUTE_RELATIVE_V1_Values_) POctetStringVal() [1]uint32{
	return *(*[1]uint32)(unsafe.Pointer(this))
}
...
type CLAIM_SECURITY_ATTRIBUTE_RELATIVE_V1 struct {
	...
	ValueCount uint32
	Values CLAIM_SECURITY_ATTRIBUTE_RELATIVE_V1_Values_
}

type CLAIM_SECURITY_ATTRIBUTES_INFORMATION_Attribute_ struct {
	Data [1]uint64
}

func (this *CLAIM_SECURITY_ATTRIBUTES_INFORMATION_Attribute_) PAttributeV1() **CLAIM_SECURITY_ATTRIBUTE_V1{
	return (**CLAIM_SECURITY_ATTRIBUTE_V1)(unsafe.Pointer(this))
}

func (this *CLAIM_SECURITY_ATTRIBUTES_INFORMATION_Attribute_) PAttributeV1Val() *CLAIM_SECURITY_ATTRIBUTE_V1{
	return *(**CLAIM_SECURITY_ATTRIBUTE_V1)(unsafe.Pointer(this))
}
...
type CLAIM_SECURITY_ATTRIBUTES_INFORMATION struct {
	...
	Attribute CLAIM_SECURITY_ATTRIBUTES_INFORMATION_Attribute_
}
...
type PLSA_AP_CALL_PACKAGE_UNTRUSTED func(ClientRequest unsafe.Pointer, ProtocolSubmitBuffer unsafe.Pointer, ClientBufferBase unsafe.Pointer, SubmitBufferLength uint32, ProtocolReturnBuffer unsafe.Pointer, ReturnBufferLength *uint32, ProtocolStatus *int32) NTSTATUS

type SEC_THREAD_START func(lpThreadParameter unsafe.Pointer) uint32
...
func GetSidLengthRequired(nSubAuthorityCount uint8) uint32 {
...
func MapGenericMask(AccessMask *uint32, GenericMapping *GENERIC_MAPPING) {
	...
	_, _,  _ = syscall.SyscallN(addr, uintptr(unsafe.Pointer(AccessMask)), uintptr(unsafe.Pointer(GenericMapping)))
}
...
func GetCachedSigningLevel(File HANDLE, Flags *uint32, SigningLevel *uint32, Thumbprint *uint8, ThumbprintSize *uint32, ThumbprintAlgorithm *uint32) BOOL {
...
func LookupPrivilegeNameA(lpSystemName PSTR, lpLuid *LUID, lpName *uint8, cchName *uint32) (BOOL, WIN32_ERROR) {
...
func LookupPrivilegeNameW(lpSystemName PWSTR, lpLuid *LUID, lpName *uint16, cchName *uint32) (BOOL, WIN32_ERROR) {
	addr := lazyAddr(&pLookupPrivilegeNameW, libAdvapi32, "LookupPrivilegeNameW")
	ret, _,  err := syscall.SyscallN(addr, uintptr(unsafe.Pointer(lpSystemName)), uintptr(unsafe.Pointer(lpLuid)), uintptr(unsafe.Pointer(lpName)), uintptr(unsafe.Pointer(cchName)))
	return BOOL(ret), WIN32_ERROR(err)
}

func LookupPrivilegeDisplayNameA(lpSystemName PSTR, lpName PSTR, lpDisplayName *uint8, cchDisplayName *uint32, lpLanguageId *uint32) (BOOL, WIN32_ERROR) {
...
func LookupPrivilegeDisplayNameW(lpSystemName PWSTR, lpName PWSTR, lpDisplayName *uint16, cchDisplayName *uint32, lpLanguageId *uint32) (BOOL, WIN32_ERROR) {
