...
const (
	...
	TT_ENABLED uint32 = 2
	PFD_TYPE_RGBA uint32 = 0
	PFD_TYPE_COLORINDEX uint32 = 1
	PFD_MAIN_PLANE uint32 = 0
	PFD_OVERLAY_PLANE uint32 = 1
	PFD_UNDERLAY_PLANE int32 = -1
	PFD_DOUBLEBUFFER uint32 = 1
	PFD_STEREO uint32 = 2
	PFD_DRAW_TO_WINDOW uint32 = 4
	PFD_DRAW_TO_BITMAP uint32 = 8
	PFD_SUPPORT_GDI uint32 = 16
	PFD_SUPPORT_OPENGL uint32 = 32
	PFD_GENERIC_FORMAT uint32 = 64
	PFD_NEED_PALETTE uint32 = 128
	PFD_NEED_SYSTEM_PALETTE uint32 = 256
	PFD_SWAP_EXCHANGE uint32 = 512
	PFD_SWAP_COPY uint32 = 1024
	PFD_SWAP_LAYER_BUFFERS uint32 = 2048
	PFD_GENERIC_ACCELERATED uint32 = 4096
	PFD_SUPPORT_DIRECTDRAW uint32 = 8192
	PFD_DIRECT3D_ACCELERATED uint32 = 16384
	PFD_SUPPORT_COMPOSITION uint32 = 32768
	PFD_DEPTH_DONTCARE uint32 = 536870912
	PFD_DOUBLEBUFFER_DONTCARE uint32 = 1073741824
	PFD_STEREO_DONTCARE uint32 = 2147483648
